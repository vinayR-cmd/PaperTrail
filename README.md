...
[![Frontend](https://img.shields.io/badge/Frontend-React%2018%20%7C%20Vite%20%7C%20Tailwind-blue)](#)
...
Here is a glimpse of the PaperTrail platform in action:

<details>
<summary><b>Click to expand screenshots</b></summary>
<br>

![Screenshot 1](images/Screenshot%202026-06-11%20202958.png)
![Screenshot 2](images/Screenshot%202026-06-11%20203020.png)
![Screenshot 3](images/Screenshot%202026-06-11%20203035.png)
![Screenshot 4](images/Screenshot%202026-06-11%20203055.png)
![Screenshot 5](images/Screenshot%202026-06-11%20203203.png)
![Screenshot 6](images/Screenshot%202026-06-11%20203244.png)
![Screenshot 7](images/Screenshot%202026-06-11%20203301.png)
...
|--------|-----------|---------|
| 🕸️ **Citation Graph** | NetworkX + Louvain | Community detection |
| 🔍 **Semantic Search** | all-MiniLM-L6-v2 + pgvector | Paper similarity |
| ⚔️ **Contradiction Detection** | DeBERTa NLI | Literature conflicts |
...
### Frontend → Vercel
1. Select the `frontend` directory as root directory in Vercel settings.
